...
<div class="domain-header">
  <h1 class="page-title">📈 Paid Ads</h1>
  <p class="page-subtitle">Meta, Google, TikTok ad frameworks, ROAS, creative strategy.</p>
</div>

{% assign domain_docs = site.documents | where: "category", "paid-ads" | sort: "date" | reverse %}
