...
<div class="domain-header">
  ...
  <p class="page-subtitle">MCP, autonomous agent architecture, LLM tooling, Claude/Codex.</p>
</div>

{% assign domain_docs = site.documents | where: "category", "ai-agents" | sort: "date" | reverse %}
