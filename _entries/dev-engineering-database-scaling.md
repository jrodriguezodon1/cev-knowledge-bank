---
title: "Database Scaling — How to Scale to Millions of Users"
date: 2026-09-12
tags: ["database", "scaling", "postgres", "redis", "architecture", "engineering"]
category: dev-engineering
source: "https://www.instagram.com/reel/Dc9vMsSMiIy/"
layout: entry
---
...
7. **Polyglot persistence** — stop asking one DB to do everything:
   - Postgres: user accounts, core data
   - Redis: sessions, caching, queues
   - Elasticsearch: search
   - S3: files, media
   - Columnar DB (BigQuery, Redshift): analytics
8. **Sharding** — LAST RESORT. Split data across multiple DBs. Serious complexity (hot shards, cross-shard queries, data migration). Only when writes are truly the bottleneck.
...
- Next lever if needed: read replicas (Supabase supports natively)
